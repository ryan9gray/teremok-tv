...
//TO DO
protocol RedesignedAnimateCellProtocol {
    ...
    var linktoLoad: String { get set }
    func setAnimation(file: String)
    var source: RedesignedMainCollectionViewCell.AnimaionSource { get set }
}

extension RedesignedAnimateCellProtocol where Self: RedesignedMainCollectionViewCell {
