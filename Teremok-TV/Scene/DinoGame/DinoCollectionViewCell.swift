...
class DinoCollectionViewCell: UICollectionViewCell {
    ...
    func configuration(dino: DinoMaster.Dino) {
        item = dino
        backImage.image = UIImage(named: "ic-dinoGameCellCover")
        frontImage.image = UIImage(named: dino.imageName)
    }
