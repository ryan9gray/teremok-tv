...
enum Main {
    ...
    enum Messages {
        ...
        static let auth = "Уважаемый пользователь, для доступа к функциям «Теремок-ТВ» необходимо зарегистрироваться и подключить нужный сервис. Благодарим вас за выбор нашего приложения!"
    }
}
